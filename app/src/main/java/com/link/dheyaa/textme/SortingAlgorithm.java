...
public class SortingAlgorithm {
    ...
    public void bubbleSortByAlphabet(ArrayList <User> friendList){
    ...
    public void sortByAlphabet(ArrayList <User> friendlist){
        quickSortBtAlphabet(friendlist,0,friendlist.size()-1);
    }

    private void quickSortBtAlphabet(ArrayList<User> friendList,int begin, int end){
